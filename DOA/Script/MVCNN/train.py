...
wandb.init(project="SNR_NS_50_50000_dropout")
#==========================================================================

df1 = sio.loadmat("../datasets/doa1/SNR_NS_50_50000_1.mat")
#==========================================================================
# label = []

# for i in range(0, 2000):
# 	label.append([df1['DOA'][i][0]])

# =============================================================


max_r = 0.24199614108225354
max_i = 0.22635605364401
max_p = 3.1415893809699975
min_r = -0.2413102295529167
min_i = -0.24059390985570245
min_p = -3.1415822822075192
...
def train():
	for i in range(200):
		...
		# print(total, "Total")
		wandb.log({"Trainig Acc":(100*(tcorrect/ttotal)), "Traningloss":(training_loss/len(train_loader)), "Validation Acc":(100*(correct/total)), "Validationloss":( validation_loss/len(validation_loader))})
