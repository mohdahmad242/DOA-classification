...
wandb.init(project="Doa1_PreTraining_50000_ALL_dropout")
# Loading Dataset  
# =============================================================


max_r = 0.5758894551931596
max_i = 0.6380853569244683
max_p = 3.141592030578154
min_r = -0.5932333778145296
min_i = -0.607271714192227
min_p = -3.1415888749544196

df = sio.loadmat("../datasets/doa1/SNR_NS_ALL_50000_1.mat")
